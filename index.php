...
$ambildata = file_get_contents('data.json');
//konversi / decode json menjadi array php

$data = json_decode($ambildata, true);
//ambil data user 
 $tampil = $data['user'];
 //tampil data user ke dalam form
?>
...
foreach ($ambildata as $tampil) {
   ?>
          ...
          <div class="portfolio-item">
            <img src="images/<?pHp echo $tampil['image'] ?>" alt="Project 1" />
            <h3><?pHp echo $tampil['title'] ?></h3>
